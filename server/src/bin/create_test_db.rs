...
use mlm_db::{
    migrate, DuplicateTorrent, ErroredTorrent, ErroredTorrentId, Event, EventType, List, ListItem,
    ListItemTorrent, MainCat, MediaType, MetadataSource, SelectedTorrent, Series, SeriesEntries,
    SeriesEntry, Size, Timestamp, Torrent, TorrentCost, TorrentMeta, TorrentStatus, Uuid, MODELS,
};
...
fn main() -> anyhow::Result<()> {
    ...
    let timestamp_with_offset =
        |offset_seconds: i64| Timestamp::from(base_timestamp.0 + Duration::seconds(offset_seconds));
    ...
    for i in 1u64..=35 {
        ...
        let replaced_with = if i == 5 {
            Some((
                "torrent-006".to_string(),
                timestamp_with_offset(i as i64 * 60 + 45),
            ))
        } else {
            None
        };
        ...
        let torrent = Torrent {
            ...
            meta: TorrentMeta {
                ...
                uploaded_at: Some(timestamp_with_offset(i as i64 * 60)),
            },
            created_at: timestamp_with_offset(i as i64 * 60 + 30),
            replaced_with,
    ...
    for i in 1u64..=5 {
        ...
        rw.insert(SelectedTorrent {
            ...
            meta: TorrentMeta {
                ...
                filetypes: vec!["m4b".to_string()],
                source: MetadataSource::Mam,
                uploaded_at: Some(timestamp_with_offset(10_000 + i as i64 * 60)),
                ..Default::default()
            },
    ...
    for i in 1u64..=5 {
        ...
        rw.insert(DuplicateTorrent {
            ...
            meta: TorrentMeta {
                ...
                filetypes: vec!["m4b".to_string()],
                source: MetadataSource::Mam,
                uploaded_at: Some(timestamp_with_offset(20_000 + i as i64 * 60)),
                ..Default::default()
            },
            created_at: timestamp_with_offset(20_000 + i as i64 * 60 + 30),
    ...
    for i in 1u64..=5 {
        ...
        rw.insert(ErroredTorrent {
            ...
            meta: None,
            created_at: timestamp_with_offset(30_000 + i as i64 * 60),
        })?;
    }
    ...
    for i in 0u64..10 {
        ...
        rw.insert(Event {
            ...
            torrent_id,
            mam_id: None,
            created_at: timestamp_with_offset(40_000 + i as i64 * 60),
            event: event_type,
        })?;
    }
