...
RUN cargo new --lib app/mlm_meta
RUN cargo new --lib app/mlm_core
RUN cargo new --lib app/mlm_web_askama
RUN cargo new --bin app/mlm_web_dioxus
RUN cargo new --bin app/server
RUN touch /app/mlm_web_dioxus/src/lib.rs
