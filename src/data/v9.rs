...
#[native_model(id = 2, version = 9, from = v8::Torrent)]
#[native_db]
pub struct Torrent {
    #[primary_key]
    pub hash: String,
    ...
    pub library_mismatch: Option<v8::LibraryMismatch>,
    pub client_status: Option<v8::ClientStatus>,
}

#[derive(Serialize, Deserialize, Debug, Clone)]
#[native_model(id = 3, version = 9, from = v8::SelectedTorrent)]
#[native_db]
...
#[derive(Serialize, Deserialize, Debug, Clone)]
#[native_model(id = 4, version = 9, from = v8::DuplicateTorrent)]
#[native_db]
...
#[derive(Serialize, Deserialize, Debug, Clone)]
#[native_model(id = 5, version = 9, from = v8::ErroredTorrent)]
#[native_db]
